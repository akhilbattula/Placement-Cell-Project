...
import com.akhil.placementcell.adapters.CustomGrid;
...
*/
                    ...
                    case 9:
                        ...
                        startActivity(intent);
                        break;
                    case 10:  intent = new Intent(MainActivity.this, ContactUs.class);
                        startActivity(intent);
                        break;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            share.putExtra(Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=com.akhil.pbsctpcelluser&hl=en");
